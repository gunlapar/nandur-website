...
<!-- Modal Popup -->
<!-- Modal Popup -->
<div id="popupModal" class="fixed inset-0 backdrop-blur-md bg-opacity-50 flex items-center justify-center z-50 hidden">
  <div class="bg-white rounded-lg shadow-lg p-6 max-w-2xl w-full relative">
    ...
    <ul class="text-gray-700 space-y-2 text-sm">
      ...
      <li><strong>Kontak:</strong> <span id="modalKontak"></span></li>
    </ul>
  </div>
</div>
...
<script>
  ...
  document.querySelectorAll('.open-modal').forEach(button => {
    button.addEventListener('click', () => {
      ...
      document.getElementById('modalKontak').textContent = button.dataset.kontak;
